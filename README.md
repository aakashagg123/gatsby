...
| [**Prompt engineering**](./prompt-engineering/README.md) 🆕 | The craft of writing input a model will reliably act on — from ChatGPT productivity patterns, through few-shot and chain-of-thought, into the prompts that drive Claude Code and other coding agents. 9 lessons. | [What prompt engineering actually is](./prompt-engineering/what-prompt-engineering-actually-is.md) |
