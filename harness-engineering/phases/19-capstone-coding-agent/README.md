...
|---|---------|----------|------|-------|
| 01 | [Minimal coding agent (loop + tools + files)](./01-minimal-agent/docs/en.md) ✅ | P2, P3, P6, P7 | Python | agent |
| 02 | [Add context, memory & permissions](./02-context-memory-permissions/docs/en.md) ✅ | P4, P8, P9 | Python | agent |
