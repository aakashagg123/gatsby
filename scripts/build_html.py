...
.hero h1{font-family:var(--sans);font-weight:700;font-size:42px;line-height:1.1;
  letter-spacing:-.025em;color:var(--ink);margin:.1em 0 .25em}
...
.lesson h2{font-family:var(--sans);font-weight:700;font-size:29px;line-height:1.18;
  letter-spacing:-.018em;color:var(--ink);margin:0}
.lesson h3{font-family:var(--sans);font-weight:600;font-size:21px;color:var(--ink);
  letter-spacing:-.012em;margin:1.8em 0 .5em}
...
.navcard .ttl{font-family:var(--sans);font-size:17px;color:var(--ink);font-weight:600;letter-spacing:-.01em}
...
.index-hero h1{font-family:var(--sans);font-weight:700;font-size:56px;line-height:1.08;
  letter-spacing:-.03em;color:var(--ink);margin:.15em 0 .3em}
...
.sec{font-family:var(--sans);font-weight:700;font-size:26px;letter-spacing:-.018em;color:var(--ink);
...
.card h3{font-family:var(--sans);font-weight:600;font-size:21px;letter-spacing:-.012em;color:var(--ink);margin:0 0 .35em}
...
@media (max-width:880px){
  ...
  .topnav{display:none}
  .iw-field input[type=range]{width:140px}
}
...
.recap h2{font-family:var(--sans);font-weight:700;font-size:27px;letter-spacing:-.018em;color:var(--ink);margin:0}
...
.iw-head h3{font-family:var(--sans);margin:0;font-size:19px;color:var(--ink);font-weight:600;letter-spacing:-.01em}
